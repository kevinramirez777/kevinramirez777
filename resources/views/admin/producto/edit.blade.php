                ...
                <form action="{{ route('admin.producto.update', $producto) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-sm-3">
                            ...
                            <input type="text" name="stock" id="stock" class="form-control" value="{{ $producto->stock }}" required>
                        </div>
                        <div class="col-sm-3">
                            <label for="orden" class="form-label">Orden</label>
                            <input type="text" name="orden" id="orden" class="form-control" value="{{ $producto->orden }}" required>
                        </div>
                        <div class="col-sm-3">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-3">
                            <div class="form-check form-switch">
                                <input type="checkbox" name="publicado" class="form-check-input" {{ $producto->publicado ? 'checked' : '' }}>
                                <label for="publicado" class="form-check-label">Publicado</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-check form-switch">
                                <input type="checkbox" name="portada" class="form-check-input" {{ $producto->portada ? 'checked' : '' }}>
                    ...
                    <div class="form-group mt-3">
                        <label for="urlfoto" class="form-label">Imagen</label><br>
                        <img src="/img/{{ $producto->urlfoto }}" class="preview">
